...
import { USER_DELETE_OPTION_HEADING } from 'languages/en/messages'
...
function Timelog(props) {
  ...
  useEffect(() => {
    ...
    initialize()
  }, [props.match.params.userId, props.asUser])
              ...
              <CardHeader>
                <Row>
                  ...
                  <Col md={11}>
                      ...
                      <div className="float-right">
                        <div>
                          ...
                          <ReactTooltip id="timeEntryTip" place="bottom" effect="solid">
                            ...
                            for other reasons when the timer wasn’t able to be used. In these cases,
                            the <br />
                            volunteer will use this button to log time as “intangible time” and then
                            request that an Admin manually change the log from Intangible to
                            Tangible.
                            <br />
                            <br />
                          </ReactTooltip>
                    ...
                    <Modal isOpen={inside} toggle={openInfo}>
